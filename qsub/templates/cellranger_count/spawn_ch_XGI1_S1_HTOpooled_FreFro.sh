...
libraries_csv=/krummellab/data1/immunox/XGI1/experiments/fastqs/10x_3prime/H_10X_libraries.csv
...
qsub -v "MEMORY=${MEMORY},FEATURE_REF=/krummellab/data1/ipi/data/refs/10x/biolegend_totalseq_hashtags.csv,CHEMISTRY=auto,TRANSCRIPTOME=/krummellab/data1/ipi/data/refs/10x/hg38,OUTDIR=${OUTDIR},LIBRARIES_CSV=${libraries_csv},SAMPLEID=${sample//./_}" \
