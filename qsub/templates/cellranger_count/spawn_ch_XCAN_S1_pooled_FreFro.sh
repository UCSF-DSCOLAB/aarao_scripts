...
libraries_csv=/krummellab/data1/immunox/XCAN1/experiments/fastqs/10x_3prime/HTO_10X_libraries.csv
...
qsub -v "MEMORY=${MEMORY},CHEMISTRY=SC3Pv3,TRANSCRIPTOME=/krummellab/data1/ipi/data/refs/10x/hg38,OUTDIR=${OUTDIR},LIBRARIES_CSV=${libraries_csv},SAMPLEID=${sample//./_}" \
