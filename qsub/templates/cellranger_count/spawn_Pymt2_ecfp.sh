...
set -o nounset
export MEMORY=384
export TRANSCRIPTOME=/data/shared/krummellab/ipi/data/refs/10x/GRCm38_ECFP

base_dir=/data/shared/krummellab/immunox/XHM/sequencing/fastqs/PYMT3/10X_3prime/
