...
base_dir=/krummellab/data1/ipi/sequencing/fastqs/10X/5prime_BCR/CRC
...
do
    ...
    uuid=`randomstr 10`
    qsub -v "UUID=${uuid},MEMORY=${MEMORY},REFERENCE=/krummellab/data1/ipi/data/refs/10x/GRCh38_VDJ,OUTDIR=${OUTDIR},FASTQDIR=${fastq_dir},SAMPLEID=${sample//./_},CHAIN=IG" \
