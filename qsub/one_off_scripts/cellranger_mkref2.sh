...
cellranger mkref --genome=hg38_unspliced \
                 --fasta=/cbc/resources/human/hg38/bwa_index/Homo_sapiens.GRCh38.dna.wholechrom.fa \
                 --genes=/data/shared/krummellab/ipi/data/refs/10x/gtfs/Homo_sapiens.GRCh38.85_10x_unspliced.gtf \
                 --nthreads=${PBS_NUM_PPN} \
                 --memgb 384

mv hg38_unspliced/ /data/shared/krummellab/ipi/data/refs/10x/hg38_unspliced/
